...
import { useAuthRedirect } from "@/components/layout/Sidebar";
...
export default function Index() {
  // Use the auth redirect hook to ensure the user is authenticated
  useAuthRedirect();
  ...
  return (
    <div className="min-h-screen bg-background antialiased">
      ...
      <main className="transition-all duration-300 pt-16 md:pl-[240px]">
